...
export default function PublicProfilePage() {
    ...
    const fetchUser = async (isPTR = false) => {
        ...
        if (error || !profileData) {
            ...
            await fetchUserContent(profileData.id, isPTR);
        }
    ...
    return (
        <PullToRefresh onRefresh={() => fetchUser(true)}>
                ...
                <div className="flex-1 pb-20 md:pb-10 w-full">
                    <div className="bg-white md:bg-[#f4f4f4] md:rounded-[2.5rem] w-full min-h-[85vh] flex flex-col overflow-hidden relative md:border md:border-gray-200 md:shadow-sm">
                        ...
                        <div className="relative pb-12 flex-1">
                            ...
                            <div className="w-full flex justify-end items-center gap-2 pt-3 md:pt-6 px-4 sm:px-8 md:px-12">
                                <button
                                    onClick={() => {
